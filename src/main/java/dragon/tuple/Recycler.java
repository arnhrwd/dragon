...
//	private final HashMap<T,Integer> map;
	private CircularBlockingQueue<T> objects;
	...
	public T newObject() {
		...
		try {
			...
			if(t==null) {
				...
				log.warn(this.getClass().getName()+" expanding by "+expansion+" to "+(capacity+expansion));
